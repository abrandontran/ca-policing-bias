...
The first visualization I want to investigate is a comparison of the number of arrests that happen across various cities in California and observe any noticeable differences in the number across cities and from daylight to nightime hours. As observed below, Los Angeles has a significantly larger number of arrests across the time period December 2009 to June 2018. 
...
ggplot(ca.df)+
  ...
  theme(legend.position = "bottom") + scale_fill_discrete(name = "Number of Arrests")
